...
public class Map {
    ...
    public static Map MapInitialization(Game g, int mapNumber) throws IOException, SQLException{
        ...
        if (mapNumber == 1) {
            ...
            //portails
            Portal port = new Portal(g,new Vec2(13, 1), new boolean[] {true,false});
            Portal port2 = new Portal(g,new Vec2(13,16), new boolean[] {true,false});
            ...
            m.objects.add(new Acid(g,1.5, new Vec2(6,13)));
